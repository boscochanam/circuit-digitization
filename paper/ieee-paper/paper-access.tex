% ============================================================================
% IEEE ACCESS submission source. Class files: paper/ieee-paper/ieeeaccess/
% (IEEE Author Center kit, 2026-05-13). Local build: latexmk -pdf paper-access.tex
% (latexmkrc sets TEXINPUTS). See paper/ieee-paper/AGENTS.md — front matter still
% needs alignment with ieeeaccess/access-sample.tex before submission.
% Conference-style local draft: paper-build.tex
% ============================================================================
