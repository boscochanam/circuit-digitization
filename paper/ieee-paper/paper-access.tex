...
Table~\ref{tab:per_circuit} shows the scale-relative completion join's performance across individual circuits at L4 (extreme error injection, 16 seeds).
