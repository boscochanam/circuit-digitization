...
\newcommand{\orcidlink}[1]{\href{https://orcid.org/#1}{\raisebox{-0.25ex}{\includegraphics[height=1.7ex]{figures/orcid.pdf}}}}
\usepackage{etoolbox}
...
on the CGHD-1152 dataset~\cite{bayer2021cghd,cghd1152data}. The evaluation images are drawn from
CGHD-1152, which is distributed under a CC~BY~4.0 licence~\cite{cghd1152data}; our released
overlays are adaptations of those images (grayscale conversion, upscaling, and ground-truth wire
polylines drawn on top) and are redistributed under the same licence, while our net annotations
are original work released under the MIT licence.
...
\bibitem{cghd1152data} F.~Thoma, J.~Bayer, and Y.~Li, ``CGHD1152,'' Zenodo, 2022, dataset, licensed CC~BY~4.0. [Online]. Available: \url{https://doi.org/10.5281/zenodo.6385814}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{figures/authors/chiwhane.jpg}}]{Shwetambari Chiwhane}
