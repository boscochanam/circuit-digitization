...
\title{From Hand-Drawn Schematics to SPICE Netlists: Endpoint-Graph Wire Joining and a Human-Verified Connectivity Benchmark}
...
\begin{IEEEkeywords}
hand-drawn circuits, circuit digitization, schematic recognition, document understanding, wire joining, graph-based connectivity, netlist extraction, SPICE, connectivity benchmark
\end{IEEEkeywords}
