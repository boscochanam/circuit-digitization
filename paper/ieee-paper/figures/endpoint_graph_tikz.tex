...
% Native TikZ; resized to the column so the document serif font is used.
...
\begin{scope}
  \node[font=\bfseries] at (2.25,2.55) {(a) Radius-based joining};
  \foreach \x/\lab in {0.2/R1,1.9/C1,3.6/R2}{
    \filldraw[comp] (\x,1.0) rectangle ++(0.7,0.9);
...
\begin{scope}[xshift=5.3cm]
  \node[font=\bfseries] at (2.25,2.55) {(b) Endpoint-graph (ours)};
  ...
  \foreach \x/\lab in {0.25/R1,1.55/C1,3.45/R2}{
    \filldraw[comp] (\x,0.35) rectangle ++(0.6,0.7);
