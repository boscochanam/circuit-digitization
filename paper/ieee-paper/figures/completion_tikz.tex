...
\foreach \dx/\after/\ttl in {0/0/{Before completion}, 6.2/1/{After completion}}{
  \begin{scope}[xshift=\dx cm]
    ...
    \ifnum\after=1
      ...
      \draw[cEE, -{Stealth[length=2.2mm]}, line width=1.6pt, dashed]
           (2.45,1.30) to[bend right=28] (3.12,1.30);
      \node[cEE, font=\itshape\footnotesize, align=center] at (2.20,2.02)
           {completion edge\\(min-cost b-matching)};
      \node[cGuard, font=\footnotesize, align=center] at (2.15,0.38)
